    ...
    div(
        ...
        div(
          ...
          div(
            ...
            downloadButton(ns("heatmap_download_pdf"), " PDF",
                           class = "btn btn-sm btn-outline-secondary flex-grow-1"),
            downloadButton(ns("heatmap_download_svg"), " SVG",
                           class = "btn btn-sm btn-outline-secondary flex-grow-1"),
          ...
          div(
            class = "d-flex gap-2",
            numericInput(ns("heatmap_export_width"), "Width (in):", value = 10, min = 1, max = 40, step = 0.5),
            numericInput(ns("heatmap_export_height"), "Height (in):", value = 6.5, min = 1, max = 40, step = 0.5)
          )
        )
      ),
      ...
      div(
        ...
        div(
          ...
          numericInput(ns("heatmap_top"), "Top CpGs (10 - 10000):", value = 1000, min = 10, max = 10000, step = 100),
